...
public class BoardPane extends JPanel {
    ...
    private void initPanes(Dimension size) {
        ...
        this.gameBoardPane.setSize(new Dimension( centerSize.width / 4, centerSize.height));
        this.gameBoardPane.setMinimumSize(new Dimension( centerSize.width / 4, centerSize.height));
        this.gameBoardPane.setPreferredSize(new Dimension(centerSize.width / 4, centerSize.height));

        this.boardSidePane.setSize(new Dimension(3*centerSize.width /4, centerSize.height));
