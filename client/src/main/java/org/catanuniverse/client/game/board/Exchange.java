...
public class Exchange extends JTabbedPane {
    ...
    private final BiConsumer<HashMap<Resource, Integer>, AbstractMap.Entry<Resource, Integer>>
            callback;
    ...
    public void update(HashMap<Resource, Integer> inputResources, Set<Harbor> harbors) {
        ...
        this.addTab(
                "Exchange", new ExchangePane(this.inputResources, Exchange.DEFAULT_COEFFICIENT));
    ...
    private void addNewPane(Harbor harbor) {
        ...
        this.addTab(
                ...
                new ExchangePane(genereateResources.get(), harbor.getCoeff()));
    }
    ...
    private class ExchangePane extends JPanel {
        ...
        /**
         * Initialise both resources to give and resource to receive as well as the confirmation
         * button
         */
        ...
        private void exchange(ActionEvent ignore) {
            ...
            Resource r =
                    Resource.valueOf(
                            this.resourceToReceiveButtonGroup.getSelection().getActionCommand());
            Exchange.this.callback.accept(
                    this.exchangeOutput, new AbstractMap.SimpleEntry<>(r, sum));
        }
    ...
    private static class SpinnerRow extends JPanel {
        ...
        public SpinnerRow(
                Resource resource, int maxValue, int currentValue, ChangeListener changeListener) {
            this.model = new SpinnerNumberModel(currentValue, 0, maxValue, 1);
