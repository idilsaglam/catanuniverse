...
class PlayerCard extends JPanel {
    ...
    public void setPlayer(Player p, int i) throws IOException {
        ...
        Image scaledImage =
                bufferedAvatarImage.getScaledInstance(
                        this.widthPlayer, this.heightPlayer, Image.SCALE_SMOOTH);
        avatarLabel.setIcon(new ImageIcon(scaledImage));
        username.setText(this.player.getUsername());
        this.setBorder(BorderFactory.createMatteBorder(0, 25, 0, 0, player.getColor()));
    ...
    private class PlayerAchievementsContainer extends JPanel {
        ...
        private final Map<Achievements, JLabel> achievementsJLabelMap = new HashMap<>(),
                achievementsJLabelImageMap = new HashMap<>();
        ...
        public void updateAchievements() {
            for (Achievements a : Achievements.values()) {
                this.achievementsJLabelMap
                        .get(a)
                        .setText("" + PlayerCard.this.player.getAchievement(a));
